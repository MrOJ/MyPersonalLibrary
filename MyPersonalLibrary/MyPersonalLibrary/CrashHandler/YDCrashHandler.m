...
- (void)handleException:(NSException *)exception
{
    ...
    UIAlertView *thisAlert = [[UIAlertView alloc] initWithTitle:@"Sorry"  message:@"An unexpected event happened causing the application to shutdown." delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
